"""
Tests for TestgameAdapter adapter.
...
def test_adapter_import():
    ...
    from adapter import TestgameAdapter
    assert TestgameAdapter is not None
...
def test_adapter_instantiation():
    ...
    assert adapter.category == "gaming"
    assert adapter.platform == "testgame"
