"""
Tests for SrccheckAdapter adapter.
...
def test_adapter_import():
    ...
    from adapter import SrccheckAdapter
    assert SrccheckAdapter is not None


def test_adapter_instantiation():
    """Verify the adapter can be instantiated."""
    from adapter import SrccheckAdapter
    adapter = SrccheckAdapter()
    assert adapter.category == "test"
    assert adapter.platform == "srccheck"
